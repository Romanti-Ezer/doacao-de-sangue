...
var GuiaInformativoPage = /** @class */ (function () {
    ...
    GuiaInformativoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-guia-informativo',template:/*ion-inline-start:"D:\projetos\doacao-sangue\src\pages\guia-informativo\guia-informativo.html"*/'<!--\n  Generated template for the GuiaInformativoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Guia Informativo</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"D:\projetos\doacao-sangue\src\pages\guia-informativo\guia-informativo.html"*/,
        }),
...
var MinhasDoacoesPage = /** @class */ (function () {
    ...
    MinhasDoacoesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-minhas-doacoes',template:/*ion-inline-start:"D:\projetos\doacao-sangue\src\pages\minhas-doacoes\minhas-doacoes.html"*/'<!--\n  Generated template for the MinhasDoacoesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Minhas Doações</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"D:\projetos\doacao-sangue\src\pages\minhas-doacoes\minhas-doacoes.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
    ], MinhasDoacoesPage);
...
var VisualizarCampanhasPage = /** @class */ (function () {
    ...
    VisualizarCampanhasPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-visualizar-campanhas',template:/*ion-inline-start:"D:\projetos\doacao-sangue\src\pages\visualizar-campanhas\visualizar-campanhas.html"*/'<!--\n\n  Generated template for the VisualizarCampanhasPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Visualizar Campanhas</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n  <ion-list>\n\n    <ion-list-header>\n\n      <h2>Campanhas</h2>\n\n    </ion-list-header>\n\n    <ion-item  *ngFor="let campanha of campanhas | async">\n\n      <p>{{campanha.endHemocentroUF}}</p>\n\n      <p>{{campanha.endHemocentroCidade}}</p>\n\n      <p>{{ campanha.dataLimite }}</p>\n\n      <p>{{ campanha.divulgadorPrecisa }}</p>\n\n      <p>{{ campanha.emailDivulgador }}</p>\n\n      <p>{{ campanha.emailHemocentro }}</p>\n\n      <p>{{ campanha.endDivulgador }}</p>\n\n      <p>{{ campanha.endDivulgadorCEP }}</p>\n\n      <p>{{ campanha.endHemocentro }}</p>\n\n      <p>{{ campanha.endHemocentroCEP }}</p>\n\n      <p>{{ campanha.grauUrgencia }}</p>\n\n      <p>{{ campanha.infAdicionais }}</p>\n\n      <p>{{ campanha.nomeDivulgador }}</p>\n\n      <p>{{ campanha.nomeHemocentro }}</p>\n\n      <p>{{ campanha.nomePaciente }}</p>\n\n      <p>{{ campanha.outroContatoHemocentro }}</p>\n\n      <p>{{ campanha.pagFacebookHemocentro }}</p>\n\n      <p>{{ campanha.possuiWhatsapp }}</p>\n\n      <p>{{ campanha.possuiWhatsapp2 }}</p>\n\n      <p>{{ campanha.siteHemocentro }}</p>\n\n      <p>{{ campanha.telDivulgador }}</p>\n\n      <p>{{ campanha.telDivulgador2 }}</p>\n\n      <p>{{ campanha.telHemocentro }}</p>\n\n      <p>{{ campanha.telHemocentro2 }}</p>\n\n      <p>{{ campanha.tipoDoacao }}</p>\n\n      <p>{{ campanha.tipoSangue }}</p>\n\n      <hr>\n\n    </ion-item>\n\n  </ion-list>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"D:\projetos\doacao-sangue\src\pages\visualizar-campanhas\visualizar-campanhas.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_publicar_campanha_publicar_campanha__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_visualizar_campanhas_visualizar_campanhas__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_minhas_doacoes_minhas_doacoes__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_minha_conta_minha_conta__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_publicar_campanha_publicar_campanha__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_visualizar_campanhas_visualizar_campanhas__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_minhas_doacoes_minhas_doacoes__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_minha_conta_minha_conta__ = __webpack_require__(199);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\projetos\doacao-sangue\src\app\app.html"*/' <!--<ion-split-pane> Exibe o menu expandido em dispositivos maiores-->\n\n<ion-menu [content]="content">\n\n  <ion-content padding>\n\n    <ion-list>\n\n      <button ion-item menuClose *ngFor="let page of pages"\n\n      (click)="goToPage(page.component);">\n\n        <ion-icon [name]="page.icone" item-left></ion-icon>\n\n      {{page.titulo}}</button>\n\n      <button ion-item menuToggle (click)="logout()">Sair\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n</ion-menu>\n\n<ion-nav [root]="rootPage" main #content swipeBackEnable="false"></ion-nav>\n\n<!--</ion-split-pane>-->'/*ion-inline-end:"D:\projetos\doacao-sangue\src\app\app.html"*/
        }),
